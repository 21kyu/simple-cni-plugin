...
import (
	...
	"github.com/21kyu/simple-cni-plugin/api/restapi/operations"
	"github.com/21kyu/simple-cni-plugin/api/restapi/operations/ipam"
)

//go:generate swagger generate server --target ../../api --name SimpleCNIServer --spec ../swagger.yml --principal interface{}

func configureFlags(api *operations.SimpleCNIServerAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.SimpleCNIServerAPI) http.Handler {
